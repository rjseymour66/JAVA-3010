...
public class MainMenu extends javax.swing.JFrame {
    ...
    private javax.swing.JMenu offeredCourseMenuOption = new javax.swing.JMenu("Courses");
    ...
    //Notice that the logging level menu choice is another menu with menu items
    ...
    public MainMenu(MainMenuController controller) {
        ...
        menuBar.add(offeredCourseMenuOption);
        ...
        offeredCourseMenuOption.add(addOfferedCourse);
        offeredCourseMenuOption.add(listOfferedCourses);
