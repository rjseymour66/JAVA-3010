...
public class Application {
    ...
    // This helps de4termine where the message came from (this is optinal)
    private static final Logger DEBUG_LOGGER = Logger.getLogger(Application.class.getName());

    // Declare the file handler for debugging. It will be created in a try/catch block below
     ...
     * args[1] - name and location of debug
     */
    public static void main(String[] args) {
        ...
        try {
            ...
            DEBUG_LOGGER.setLevel(Level.ALL);
