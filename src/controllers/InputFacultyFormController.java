        ...
        try {
            ...
            try {
                ...
                if (salarydouble < 0.0) {
                    ...
                    Application.getDEBUG_LOGGER().info("Salary set to zero");
                    new ErrorPopup(form, new InvalidDataException("Invalid salary, setting to zero"));
                } else {
            ...
            if (dateOfHire.isBefore(dateOfBirth)) {
                Application.getDEBUG_LOGGER().warning("Invalid birthdate");
                Application.getDEBUG_LOGGER().info("Birthdate not saved");
                throw new InvalidDataException("Date of hire cannot be before date of birth.\nInput was not saved.");
            }
